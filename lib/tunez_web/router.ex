defmodule TunezWeb.Router do
  ...
  scope "/", TunezWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TunezWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", TunezWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{TunezWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", TunezWeb do
    ...
    live_session :current_user,
      on_mount: [{TunezWeb.UserAuth, :mount_current_user}] do
